                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card m-b-30">
                                <div class="card-body">
                                    <h4 class="mt-0 m-b-30 header-title">Messages non lus <span class="badge badge-info">{{$nonlu->count()}}</span></h4>
                                        ...
                                        <table class="table m-t-20 mb-0 table-vertical">
                                            ...
                                            @empty
                                                <tr>
                                                    ...
                                                    <td class="text-center" style="color: red; font-size:20px">Aucun message non lu</td>
                                                    <td class="text-center"></td>
                                                    <td class="text-center"></td>
                                                </tr>
                                            @endforelse
