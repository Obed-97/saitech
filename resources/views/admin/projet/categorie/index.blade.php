                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form class="" method="POST" action="{{route('category_projet.store')}}" enctype="multipart/form-data">
                ...
                <div class="col-lg-4">
                    <div class="card m-b-30 text-white card-info">
                        <div class="card-body">
                            ...
                            <div class="d-flex">
                                <a href="{{route('category_projet.show', $item->id)}}" class="btn btn-sm btn-primary waves-effect waves-light mr-1">Voir les détails</a>
                                @can('Modifier')
                                <a href="{{route('category_projet.edit', $item->id)}}" class="btn btn-sm btn-secondary waves-effect waves-light mr-1"><i class="fa fa-pencil"></i></a>
                                <form method="POST" action="{{route('category_projet.destroy', $item->id)}}">
                                    @csrf
                                    {{method_field('DELETE')}}
